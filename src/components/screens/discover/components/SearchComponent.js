...
const SearchComponent = ({ onSearchForAuthor, onToggleDarkLayer, isTextInputFocused, onTypeAuthorName, navigation }: Props): Object => (
	<Container>
		<ScreenTitle title="Discover" />
		<SearchAuthorTextInputWrapper>
			<SearchAuthorTextInput onSearchForAuthor={onSearchForAuthor} onToggleDarkLayer={onToggleDarkLayer} onTypeAuthorName={onTypeAuthorName} />
		</SearchAuthorTextInputWrapper>
		<SubjectsListWrapper isTextInputFocused={isTextInputFocused}>
			<SubjectsList isTextInputFocused={isTextInputFocused} navigation={navigation} />
		</SubjectsListWrapper>
	</Container>
)
