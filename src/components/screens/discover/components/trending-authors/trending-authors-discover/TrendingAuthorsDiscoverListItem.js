...
const TrendingAuthorsListItem = ({ isLastIndex, isFirst, onPress, author }: Props): Object => (
	<Wrapper
	...
	>
		...
		<TextContent>
			...
			<NumberOfPodcasts>{`${author.podcasts.length} ${author.podcasts.length === 1 ? 'Podcast' : 'Podcasts'}`}</NumberOfPodcasts>
		</TextContent>
		<ButtonWrapper>
