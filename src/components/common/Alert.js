...
const configs = {
	...
	[TYPES.REMOVE_DOWNLOADED_PODCAST]: {
		title: 'Remove Downloaded Podcast',
		description: 'Are you sure to remove this Podcast permanently from your device?',
		positiveText: 'Yes',
	},

	[TYPES.DOWNLOAD_PODCAST]: {
		title: 'Download Podcast',
		description: 'Are you sure you want to Download this podcast? It can take a while.',
		positiveText: 'Yes',
	},
	...
	[TYPES.ADD_UNDOWNLOADED_PODCAST_PLAYLIST_AVAILABLE_OFFLINE]: {
		...
		description: 'This Playlist is Available Offline. When you add this podcast to this playlist, it will be downloaded automatically.',
		positiveText: 'OK',
	},
