...
const getStars = (stars: number, isSmall: boolean): Array<Object> => {
	...
	const FullStar = <Icon color={appStyle.colors.yellow} size={iconSize} name="star" />

	const HalfStar = <Icon color={appStyle.colors.yellow} name="star-half" size={iconSize} />

	const EmptyStar = <Icon color={appStyle.colors.yellow} name="star-outline" size={iconSize} />
...
const ReviewStars = ({ shouldShowReviewsText, textColor, isSmall, reviews, stars }: Props) => (
	<Wrapper>
