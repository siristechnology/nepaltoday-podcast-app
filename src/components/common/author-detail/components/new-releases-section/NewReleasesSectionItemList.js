...
const NewReleasesSectionItemList = ({ isLastIndex, imageURL, onPress, subject, title, stars }: Props): Object => (
	<Container isLastIndex={isLastIndex} onPress={onPress}>
		...
		<ContentWrapper>
			<ReviewStars shouldShowReviewsText={false} isSmall={false} stars={stars} />
			<View>
				<Title>{title}</Title>
