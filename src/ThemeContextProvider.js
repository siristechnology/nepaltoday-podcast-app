...
class ThemeContextProvider extends Component<Props, State> {
	...
	async componentDidMount() {
		const isFirstTimeRunningApp = await getItemFromStorage(CONSTANTS.KEYS.FIRST_TIME_RUNNING_APP, false)
		...
		const appThemeFromStorage = await getItemFromStorage(CONSTANTS.KEYS.APP_THEME, false)
