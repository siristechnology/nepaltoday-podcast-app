export const Types = {
	CLEAR_LOCAL_PODCASTS_REFERENCES_REQUEST: 'localPodcastsManager/CLEAR_LOCAL_PODCASTS_REFERENCES_REQUEST',
	CLEAR_LOCAL_PODCASTS_REFERENCES_SUCCESS: 'localPodcastsManager/CLEAR_LOCAL_PODCASTS_REFERENCES_SUCCESS',
	SET_PODCASTS_DOWNLOADED_LIST_SUCCESS: 'localPodcastsManager/SET_PODCASTS_DOWNLOADED_LIST_SUCCESS',
	SET_PODCASTS_DOWNLOADED_LIST_REQUEST: 'localPodcastsManager/SET_PODCASTS_DOWNLOADED_LIST_REQUEST',
	REMOVE_FROM_DOWNLOADED_LIST: 'localPodcastsManager/REMOVE_FROM_DOWNLOADED_LIST',
	...
	REMOVE_FROM_DOWNLOADING_LIST: 'localPodcastsManager/REMOVE_FROM_DOWNLOADING_LIST',
	DOWNLOAD_PODCAST: 'localPodcastsManager/DOWNLOAD_PODCAST',
	REMOVE_PODCAST: 'localPodcastsManager/REMOVE_PODCAST',
	LOAD_PODCASTS_RECENTLY_PLAYED_REQUEST: 'localPodcastsManager/LOAD_PODCASTS_RECENTLY_PLAYED_REQUEST',
	LOAD_PODCASTS_RECENTLY_PLAYED_SUCCESS: 'localPodcastsManager/LOAD_PODCASTS_RECENTLY_PLAYED_SUCCESS',
	ADD_PODCAST_RECENTLY_PLAYED_REQUEST: 'localPodcastsManager/ADD_PODCAST_RECENTLY_PLAYED_REQUEST',
	ADD_PODCAST_RECENTLY_PLAYED_SUCCESS: 'localPodcastsManager/ADD_PODCAST_RECENTLY_PLAYED_SUCCESS',
}
...
const localPodcastsManagerCreators = (state = INITIAL_STATE, { payload, type }) => {
	switch (type) {
