...
export const getDefaultHeaderWithTitle = (title: string, navigation: Object, screenProps: Object): Object => {
	const { params } = navigation.state
...
export const getDefaultHeaderWithButton = (navigation: Object, screenProps: Object, title: string, icon: string): Object => {
	const { params } = navigation.state
	const { theme } = screenProps

	const onPressHeaderButton = params && params[CONSTANTS.PARAMS.HEADER_ACTION]
	const headerWithTitleStyle = getDefaultHeaderWithTitle(title, navigation, screenProps)
...
export const setHeaderPlayButtonPress = (playlist: Array<Object>, navigation: Object): void => {
...
export const getHiddenHeaderLayout = (screenProps: Object, colorOverride: ?string): Object => {
	const { theme } = screenProps
